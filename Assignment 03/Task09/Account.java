public class Account {
  ...
  public void withdraw(int amount){
    ...
    if( (balance - amount) > 100.0){   //checks the difference only, no values changed
      this.balance = this.balance - amount;  //balance is now updated
      System.out.println("Withdraw successful! New balance is: " + this.balance);
    }
    else{  //withdraw is not possible since balance is insufficient
